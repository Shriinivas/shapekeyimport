...
2.8x and 3.x (Script File - shapekeyimport_2_8.py) <br>
2.79b (Script File - shapekeyimport.py) <br>

# Installation
For Blender 2.8x and 3.x, download shapekeyimport_2_8.py; for 2.79b download svgimport.py<br><br>
...
You can invoke the add-on in 2.79 by pressing spacebar or in 2.8x / 3.x by pressing F3 in the 3d view and selecting the <br>
